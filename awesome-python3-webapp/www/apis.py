...
class APIError(StandardError):
	'''
	the base APIError wich contains error(required),data(optional),and message(optional)
	'''
...
class APIValueError(APIError):
	'''
	Indicate the value if error or invalid .The data specifies the error field of input form 
	'''
